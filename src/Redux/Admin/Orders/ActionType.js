...
// Action types for returned order
export const RETURNED_ORDER_REQUEST = 'CANCELED_ORDER_REQUEST';
export const RETURNED_ORDER_SUCCESS = 'CANCELED_ORDER_SUCCESS';
export const RETURNED_ORDER_FAILURE = 'CANCELED_ORDER_FAILURE';
