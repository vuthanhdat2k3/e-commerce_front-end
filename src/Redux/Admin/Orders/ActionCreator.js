import { CANCELED_ORDER_FAILURE, CANCELED_ORDER_REQUEST, CANCELED_ORDER_SUCCESS, RETURNED_ORDER_FAILURE, RETURNED_ORDER_REQUEST, RETURNED_ORDER_SUCCESS, CONFIRMED_ORDER_FAILURE, CONFIRMED_ORDER_REQUEST, CONFIRMED_ORDER_SUCCESS, DELETE_ORDER_FAILURE, DELETE_ORDER_REQUEST, DELETE_ORDER_SUCCESS, DELIVERED_ORDER_FAILURE, DELIVERED_ORDER_REQUEST, DELIVERED_ORDER_SUCCESS, GET_ORDERS_FAILURE, GET_ORDERS_REQUEST, GET_ORDERS_SUCCESS, PLACED_ORDER_FAILURE, PLACED_ORDER_REQUEST, PLACED_ORDER_SUCCESS, SHIP_ORDER_FAILURE, SHIP_ORDER_REQUEST, SHIP_ORDER_SUCCESS } from "./ActionType";
...
export const confirmedOrderRequest = () => ({
  ...
  // Action creators for returned order
  export const returnedOrderRequest = () => ({
    type: CANCELED_ORDER_REQUEST,
  });
  
  export const returnedOrderSuccess = (data) => ({
    type: CANCELED_ORDER_SUCCESS,
    payload: data,
  });
